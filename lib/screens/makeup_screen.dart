...
class _BeautyScreenState extends State<MakeUpScreen> with TickerProviderStateMixin {
  ...
  final Map<String, String> _categoryImages = {
    ...
    "Lip Makeup": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbs3vXbMUZ9EsAkQUauyL-0CjxrRzUVg5DbwcC5xr7R0duxK914qKNY3NhX8VcPInL_Qk&usqp=CAU",
                          ...
                          builder: (context, constraints) {
                            ...
                            return GridView.count(
                              ...
                              section.toLowerCase().contains(_searchQuery) ||
                                  _beautyTypes[section]!.any((type) => type.toLowerCase().contains(_searchQuery)))
                                  .map((section) {
